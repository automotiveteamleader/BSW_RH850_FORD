###############################################################################
# File Name  : Cry_30_Rh850Icum_rules.mak                                     #
...
# ----------   -------  ------ -----------------------------------------------#
# 2015-05-22   1.00.00  vistof Creation for ASR 4.0.3                         #
# 2015-08-03   1.01.00  vistof Added Cry_SheKeyWrapSym                        #
# 2015-09-29   1.01.01  vistof Corrected reference to Cry_SheKeyWrapSym.c     #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += Cry_30_Rh850Icum
Cry_30_Rh850Icum_FILES   = Cry_30_Rh850Icum\Cry_30_Rh850Icum*.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Cry_30_Rh850Icum\Cry_30_Rh850Icum*.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Cry_30_Rh850Icum_Cfg.c
