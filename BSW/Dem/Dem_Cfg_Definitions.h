...
#  if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if (Dem_Cfg_GetCallbackGetFdcIdxOfEventTable(EventId) >= Dem_Cfg_GetSizeOfCallbackGetFdc())
  {
  ...
  )
{
  ...
  return ((uint32)(Dem_Cfg_GetEnableConditionMaskOfEnableConditionTable(Dem_Cfg_GetEnableConditionTableIdxOfEventTable((EventId)))));
#else
  return (uint32)1; /* enable condition 'control DTC setting' */
#endif
}
...
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return Dem_Cfg_GetStorageConditionMaskOfStorageConditionTable(Dem_Cfg_GetStorageConditionTableIdxOfEventTable(EventId));
}
#endif
...
{
#if (DEM_CFG_SUPPORT_ENABLE_CONDITIONS == STD_ON)
  return DEM_CFG_GLOBAL_ENABLE_COND_INIT;
#else
  return 0x01;
#endif
}
...
{
  return DEM_CFG_GLOBAL_STORAGE_COND_INIT;
}
#endif
