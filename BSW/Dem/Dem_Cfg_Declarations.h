...
/* ****************************************************************************
 * Dem_Cfg_EventEnableConditions
 *****************************************************************************/
/*!
 * \brief         Get the enable conditions relevant for an event
 *
 * \details       Get the enable conditions relevant for an event.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        Bit mask with 1 set for each enable condition relevant for
 *                the event.
 *
 * \pre           -
 *
...
/* ****************************************************************************
 * Dem_Cfg_EventStorageConditions
 *****************************************************************************/
/*!
 * \brief         Get the storage conditions relevant for an event
 *
 * \details       Get the storage conditions relevant for an event.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        Bit mask with 1 set for each storage condition relevant for
 *                the event.
 *
 * \pre           -
...
#if (DEM_CFG_SUPPORT_ENABLE_CONDITIONS == STD_ON) && (DEM_DEV_ERROR_DETECT == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_GlobalEnableCondCount
 *****************************************************************************/
/*!
 ...
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_ENABLE_CONDITIONS == STD_ON && DEM_DEV_ERROR_DETECT == STD_ON
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
...
/* ****************************************************************************
 * Dem_Cfg_GlobalEnableCondInit
 *****************************************************************************/
/*!
 * \brief         Get the initialization state of the enable conditions
 *
 * \details       The initialization state is a bit mask with a bit encoding
 *                the state after initialization of each enable condition.
 *                ControlDTCSetting is always enable condition 0, so bit 0 is
 *                always set
 *
 * \return        Initialization mask for enable conditions
 *                0x01 if no enable conditions are configured
 *
 * \pre           -
 *
 * \context       TASK|ISR2
...
#if (DEM_CFG_SUPPORT_STORAGE_CONDITIONS == STD_ON) && (DEM_DEV_ERROR_DETECT == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_GlobalStorageCondCount
 *****************************************************************************/
/*!
...
#if (DEM_CFG_SUPPORT_STORAGE_CONDITIONS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_GlobalStorageCondInit
 *****************************************************************************/
/*!
 * \brief         Get the initialization state of the storage conditions
 *
 * \details       The initialization state is a bit mask with a bit encoding
 *                the state after initialization of each storage condition.
 *
 * \return        Initialization mask for storage conditions
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_STORAGE_CONDITIONS == STD_ON
 *
...
#if (DEM_FEATURE_NEED_IUMPR == STD_ON) && ((DEM_FEATURE_NEED_SUPPRESSION == STD_OFF) || (DEM_DEV_RUNTIME_CHECKS == STD_ON))
/* ****************************************************************************
