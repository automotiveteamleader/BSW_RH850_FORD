...
{
  return (P2VAR(Os_AlarmType, AUTOMATIC, OS_VAR_NOINIT))Os_JobGetDyn(&(Alarm->Job));                                    /* SBSW_OS_AL_JOBGETDYN_001 */  /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2CONST(Os_AlarmSetEventConfigType, AUTOMATIC, OS_CONST))Job;                                                 /* PRQA S 0310, 3305 */ /* MD_Os_0310, MD_Os_3305 */
}
...
{
  return (P2CONST(Os_AlarmActivateTaskConfigType, AUTOMATIC, OS_CONST))Job;                                             /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2CONST(Os_AlarmIncrementCounterConfigType, AUTOMATIC, OS_CONST))Job;                                         /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2CONST(Os_AlarmCallbackConfigType, AUTOMATIC, OS_CONST))Job;                                                 /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
))
{
  ...
  else if(OS_UNLIKELY(Increment == 0))
  {
...
{
  return (Os_StdReturnType)(Os_AlarmGetDyn(Alarm)->State == OS_ALARMSTATE_CANCELED);                                    /* SBSW_OS_FC_PRECONDITION */
}
...
{
  return (Os_StdReturnType)(Os_AlarmGetDyn(Alarm)->State == OS_ALARMSTATE_SET);                                         /* SBSW_OS_FC_PRECONDITION */
}
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(targetCore == Os_ThreadGetCore(currentThread))                                                                 /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_AL_THREADGETCORE_001 */
      {
