 ...
 *  Os_TimerHrtInit()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,                                           /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */ /* PRQA S 3219 */ /* MD_Os_3219 */
Os_TimerHrtInit,
(
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE                                                                            /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */ /* COV_OS_HALPLATFORMTPUNSUPPORTED_XX */ /* PRQA S 3219 */ /* MD_Os_3219 */
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE                                                                            /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */ /* PRQA S 3219 */ /* MD_Os_3219 */
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(                                                                                           /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */ /* PRQA S 3219 */ /* MD_Os_3219 */
...
))                                                                                                                      /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */
{
  ...
  if(OS_UNLIKELY(Os_CounterIsFutureValue(&(Timer->Counter), ExpirationTime, now) == 0))                                 /* SBSW_OS_FC_PRECONDITION */
  {
    ...
    if (Os_Hal_IntIsPeripheralInterruptTriggerSupported() != 0)                                                         /* COV_OS_HALPLATFORMPERIPHERALINTTRIGGERSUPPORTED */
    {
    ...
    else
    {
      ...
      }while (OS_UNLIKELY(Os_CounterIsFutureValue(&(Timer->Counter), compareValue, timeAfterSetCompare) == 0));         /* SBSW_OS_FC_PRECONDITION */
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_TickType, OS_CODE, OS_ALWAYS_INLINE,                                    /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */ /* COV_OS_HALPLATFORMTPUNSUPPORTED_XX */ /* PRQA S 3219 */ /* MD_Os_3219 */
Os_TimerHrtGetCompareValue,
(
  P2CONST(Os_TimerHrtConfigType, AUTOMATIC, OS_CONST) Timer
))                                                                                                                      /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */ /* COV_OS_HALPLATFORMTPUNSUPPORTED_XX */
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_TickType, OS_CODE, OS_ALWAYS_INLINE,                                    /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */ /* PRQA S 3219 */ /* MD_Os_3219 */
Os_TimerHrtUserModulo,
(
  P2CONST(Os_TimerHrtConfigType, AUTOMATIC, OS_CONST) Timer,
  Os_TickType Value
