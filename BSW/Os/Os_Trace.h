...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
...

    {
      ...
      OS_VTH_SCHEDULE((OS_TRACE_INVALID_THREAD)               ,                                                         /* PRQA S 3112 */ /* MD_Os_3112_Hook */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
...

    {
      ...
      CoreIdType coreId;
      coreId = Os_CoreGetId(Os_CoreGetCurrentCore());                                                                   /* SBSW_OS_TRACE_COREGETID_001 */
      OS_VTH_SCHEDULE( (Current->Id)                           ,                                                        /* PRQA S 3112 */ /* MD_Os_3112_Hook */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    OS_VTH_FORCED_TERMINATION((KilledIsr->Id), (Os_CoreGetId(Os_CoreGetCurrentCore())))                                 /* SBSW_OS_TRACE_COREGETID_001 */ /* PRQA S 3112 */ /* MD_Os_3112_Hook */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    if(IsTaskSuspended == 0)
    {
      ...
      OS_VTH_FORCED_TERMINATION((KilledTask->Id), (Os_CoreGetId(Os_CoreGetCurrentCore())))                              /* SBSW_OS_TRACE_COREGETID_001 */ /* PRQA S 3112 */ /* MD_Os_3112_Hook */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    /* variable values are casted in order to assure that they cannot be written in the hook */
    OS_VTH_ACTIVATION_LIMIT((Task->Id), ((CoreIdType) coreId), ((CoreIdType) coreId))                                   /* PRQA S 3112 */ /* MD_Os_3112_Hook */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    /* variable values are casted in order to assure that they cannot be written in the hook */
    OS_VTH_WAITEVENT_NOWAIT((Task->Id)                ,                                                                 /* PRQA S 3112 */ /* MD_Os_3112_Hook */
                           ((EventMaskType) EventMask),
                           ((CoreIdType) coreId)      ,
                           ((CoreIdType) coreId)       )
