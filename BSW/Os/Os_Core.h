 ...
 *  Os_CoreAsr2Core()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE                                                                            /* PRQA S 3219 */ /* MD_Os_3219 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
...
{
  return (Os_StdReturnType)(Core->Status->ActivationState == OS_CORESTATE_ACTIVATED_ASR);
}
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_CoreAsrCoreIdx, OS_CODE,                                                /* PRQA S 3219 */ /* MD_Os_3219 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE P2VAR(Os_ThreadClassType, AUTOMATIC, OS_VAR_NOINIT), OS_CODE,              /* PRQA S 3219 */ /* MD_Os_3219 */
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_CoreCriticalUserSectionEnter,          /* PRQA S 3219 */ /* MD_Os_3219 */
(
...
))
{
  ...
  Os_Assert((Os_StdReturnType)(Os_CoreAsrGetAsrStatus(CoreAsr)->CriticalUserSection != 0));                             /* SBSW_OS_FC_PRECONDITION */
}
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_CoreCriticalUserSectionLeave,          /* PRQA S 3219 */ /* MD_Os_3219 */
(
  P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) CoreAsr
))
{
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE boolean, OS_CODE, OS_ALWAYS_INLINE, Os_CoreCriticalUserSectionIsActive,    /* PRQA S 3219 */ /* MD_Os_3219 */
(
  P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) CoreAsr
))
{
  /* #10 Return if OS is executed in critical user section. */
  return (boolean)(Os_CoreAsrGetAsrStatus(CoreAsr)->CriticalUserSection != 0);                                          /* SBSW_OS_FC_PRECONDITION */
}
...
{
  return (Os_StdReturnType)(Os_Hal_ContextIsExceptionContextSupported() != 0);
}
