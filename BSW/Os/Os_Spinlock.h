...
#if !defined(OS_SPINLOCK_H)                                                                                             /* PRQA S 0883 */ /* MD_Os_0883 */
...
#if !defined(OS_VCAST_INSTRUMENTATION_OS_SPINLOCK)
...
{
  return (P2VAR(Os_SpinlockType, AUTOMATIC, OS_VAR_NOINIT))Os_LockGetDyn(&(Spinlock->Lock));                            /* PRQA S 0310 */ /* MD_Os_0310 */ /* SBSW_OS_FC_PRECONDITION */
...
#  pragma warning 561   /* This suppresses the warning with regard to "access out of bound". This can be
                           suppressed here, since this warning is only reported by the compiler if no spinlock
                           is configured. In this case Os_SpinlockId2Spinlock will never be used during run-time. */
# endif
/***********************************************************************************************************************
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,                                           /* PRQA S 3219 */ /* MD_Os_3219 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
Os_SpinlockInternalGet,
(
  P2CONST(Os_SpinlockConfigType, AUTOMATIC, OS_CONST) Spinlock
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_Hal_SpinlockResultType, OS_CODE,                                        /* PRQA S 3219 */ /* MD_Os_3219 */
...
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  ...
  if(Os_ErrIsKillingEnabled() != 0)                                                                                     /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
...
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  ...
  if(Os_ErrIsKillingEnabled() != 0)                                                                                     /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
    ...
    Os_Assert((Os_StdReturnType)(spinlockDyn->OwnerThread == Os_CoreGetThread()));
