...
)
{
  ...
  /* #70 Call the respective initialization function of the idle thread. */
  Os_ThreadInit2(idleThread);                                                                                           /* SBSW_OS_CORE_THREADINIT2_001 */

  /* #80 Call the initialization function of the error subcomponent. */
  Os_ErrInit(&(coreDyn->LastError));                                                                                    /* SBSW_OS_CORE_ERRINIT_001 */

  /* #90 Initialize core variables to be able to use the Os_GetUnhandled*() API. */
