...
# define Os_Hal_Expand(x)   Os_Hal_Expand2(x)                                                                           /* PRQA S 3453 */ /* MD_Os_Hal_3453_Expand */
# define Os_Hal_Expand2(x)  Os_Hal_Expand3(x)                                                                           /* PRQA S 3453 */ /* MD_Os_Hal_3453_Expand */
# define Os_Hal_Expand3(x)  #x                                                                                          /* PRQA S 0341 */ /* MD_Os_Hal_0341_Expand */
...
/* module specific MISRA deviations:
 ...
 MD_Os_Hal_0341_Expand:
      ...
      Risk:       None.
      Prevention: None.
 MD_Os_Hal_3453_Expand:
      Reason:     The purpose of this macro, is to expand macros.
