...
typedef union
{                                                                                                                       /* PRQA S 0750 */ /* MD_Os_0750_Peripheral */
...
))
{
  ...
  if(Os_MpIsEnabled() != 0)
  {
    ...
    if(Os_Hal_CoreIsPrivilegedModeUserReadable() != 0)                                                                  /* COV_OS_HALPLATFORMPRIVILEGEMODEUSERREADABILITY */
    {
      /* #30 Read privileged mode from hardware. */
      result = !Os_Hal_CoreGetPrivilegedMode();
    }
    /* #40 Else if the thread pointer is readable in user mode: */
    else if(Os_Hal_CoreIsThreadPointerUserReadable() != 0)                                                              /* COV_OS_HALPLATFORMTHREADPOINTERUSERREADABILITY_TX_XF */
    {
      /* #50 Read privileged mode from thread. */
      result = !Os_TrapIsCurrentThreadPrivileged();
    }
...
))
{
  ...
  if(Os_MpIsEnabled() != 0)
  {
    ...
    else
    {
      ...
      if(Os_Hal_CoreIsThreadPointerUserReadable() != 0)                                                                 /* COV_OS_HALPLATFORMTHREADPOINTERUSERREADABILITY_TX_XF */
      {
        /* #60 If CoreId is readable in user mode: */
        if(Os_Hal_CoreIsCoreIdUserReadable() != 0)                                                                      /* COV_OS_HALPLATFORMCOREIDUSERREADABILITY_TX_XF */
        {
...
))
{
  ...
  if(Os_MpIsEnabled() != 0)                                                                                             /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
    ...
    if(Os_Hal_CoreIsThreadPointerUserReadable() != 0)                                                                   /* COV_OS_HALPLATFORMTHREADPOINTERUSERREADABILITY_TX_XF */
    {
      ...
      if(Os_TrapIsTrapForWriteAccessRequired() != 0) {
    ...
    else if(Os_Hal_CoreIsPrivilegedModeUserReadable() != 0)                                                             /* COV_OS_HALPLATFORMPRIVILEGEMODEUSERREADABILITY */
    {
...
)
{
  ...
  /* #10 If a trap is needed: */
  if(Os_TrapIsTrapForWriteAccessRequired() != 0)                                                                        /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
    Os_TrapPacketType packet;
 ...
 * */
  ...
  if(Os_TrapIsTrapRequired(IsTrapRequired) != 0)
  {
    Os_TrapPacketType packet;
...
)
{
  ...
  /* #10 If trap is required: */
  if(Os_TrapIsTrapRequired(IsTrapRequired) != 0)                                                                        /* COV_OS_HALPLATFORM_NEED_NO_TRAP_IOC_MULTIQUEUE */
  {
    Os_TrapPacketType packet;
...
)
{
  ...
  /* #10 If a trap is needed: */
  if(Os_TrapIsTrapForReadAccessRequired() != 0)
  {
    Os_TrapPacketType packet;
...
)
{
  ...
  /* #10 If a trap is needed: */
  if(Os_TrapIsTrapForReadAccessRequired() != 0)                                                                         /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
    Os_TrapPacketType packet;
...
)
{
  ...
  /* #10 Check that the given pointer is valid. */
  if(OS_UNLIKELY(Os_ErrCheckPointerIsNotNull(Success) == OS_CHECK_FAILED))                                              /* SBSW_OS_TRAP_ERRCHECKPOINTERISNOTNULL_001 */
  {
...
)
{
  ...
  /* #10 Check that the given pointer is valid. */
  if(OS_UNLIKELY(Os_ErrCheckPointerIsNotNull(IsEnabled) == OS_CHECK_FAILED))                                            /* SBSW_OS_TRAP_ERRCHECKPOINTERISNOTNULL_001 */
  {
    status = OS_STATUS_PARAM_POINTER_2;
  }
  else
...
)
{
  ...
  /* #10 Check that the given pointer is valid. */
  if(OS_UNLIKELY(Os_ErrCheckPointerIsNotNull(IsPending) == OS_CHECK_FAILED))                                            /* SBSW_OS_TRAP_ERRCHECKPOINTERISNOTNULL_001 */
  {
    status = OS_STATUS_PARAM_POINTER_2;
  }
  else
...
)
{
  ...
  /* #10 If a trap is needed: */
  if(Os_TrapIsTrapForReadAccessRequired() != 0)                                                                         /* COV_OS_HALPLATFORMTRAPALWAYSNEEDED */
  {
    Os_TrapPacketType packet;
...
{
  Os_PeripheralConstInt2AddressType converter;                                                                          /* PRQA S 0759 */ /* MD_Os_0759_Peripheral */
...
{
  Os_PeripheralInt2AddressType converter;                                                                               /* PRQA S 0759 */ /* MD_Os_0759_Peripheral */
...
)
{
  ...
  /* #10 If a trap is needed: */
  if(Os_TrapIsTrapForWriteAccessRequired() != 0)                                                                        /* COV_OS_HALPLATFORMTRAPALWAYSNEEDED */
  {
    Os_TrapPacketType packet;
...
)                                                                                                                       /* COV_OS_UNSUPPORTED93813 */
{
  ...
  /* #10 If a trap is needed: */
  if(Os_TrapIsTrapForWriteAccessRequired() != 0)                                                                        /* COV_OS_UNSUPPORTED93813 */
  {
    Os_TrapPacketType packet;
...
)
{
  ...
  /* #10 Check that the given pointer is valid. */
  if(OS_UNLIKELY(Os_ErrCheckPointerIsNotNull(ErrorRef) == OS_CHECK_FAILED))                                             /* SBSW_OS_TRAP_ERRCHECKPOINTERISNOTNULL_001 */
  {
    status = OS_STATUS_PARAM_POINTER_1;
  }
  else
