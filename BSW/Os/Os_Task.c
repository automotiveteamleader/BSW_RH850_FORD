...
)
{
  ...
  else if(OS_UNLIKELY(Os_TpCheckInterArrival(timingProtection, Os_ThreadGetTpConfig(taskThread)) == OS_CHECK_FAILED))   /* COV_OS_HALPLATFORMTPUNSUPPORTED_XF */ /* SBSW_OS_TASK_TPCHECKINTERARRIVAL_001 */ /* SBSW_OS_TASK_THREADGETTPCONFIG_001 */
  {
    status = OS_STATUS_OK;
  }
  else
...
)
{
  ...
  if(OS_UNLIKELY(Os_TpCheckInterArrival(timingProtection, Os_ThreadGetTpConfig(taskThread)) == OS_CHECK_FAILED))        /* COV_OS_HALPLATFORMTPUNSUPPORTED_XF */ /* SBSW_OS_TASK_TPCHECKINTERARRIVAL_001 */ /* SBSW_OS_TASK_THREADGETTPCONFIG_001 */
  {
    status = OS_STATUS_OK;
  }
  else
  ...
  else
  {
    ...
    else
    {
      ...
      if(currentTask == targetTask)
      {
        ...
        if(OS_UNLIKELY(Os_TpCheckInterArrival(timingProtection, Os_ThreadGetTpConfig(currentThread)                     /* COV_OS_HALPLATFORMTPUNSUPPORTED_XF */ /* SBSW_OS_TASK_TPCHECKINTERARRIVAL_001 */ /* SBSW_OS_TASK_THREADGETTPCONFIG_001 */
                                              ) == OS_CHECK_FAILED))
        {
