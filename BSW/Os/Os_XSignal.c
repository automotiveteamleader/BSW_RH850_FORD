 ...
 *
  ...
  return (Os_StdReturnType) ( (XSigRecvElement->SendData->Acknowledge == OS_XSIGSTATE_ASYNC_NACK) ||
      ...
      if(Os_CoreIsStartedAsAsr(Os_CoreAsr2Core(sendCore)) != 0)                                                         /* SBSW_OS_XSIG_COREISSTARTEDASASR */ /* SBSW_OS_XSIG_COREASR2CORE_001 */
      {
        ...
        if(Os_XSigChannelReceiveCheckInRange(&(recvPort->RecvChannel)) != 0)                                            /* SBSW_OS_XSIG_XSIGCHANNELRECEIVECHECKINRANGE */
        {
          ...
          if(Os_XSigChannelIsReceiveElementAvailable(&(recvPort->RecvChannel)) != 0)                                    /* SBSW_OS_XSIG_XSIGCHANNELISRECEIVEELEMENTAVAILABLE_001 */
          {
            ...
            if(Os_XSigRecvCheckIsReceiveElementValid(comData) != 0)                                                     /* SBSW_OS_XSIGRECVCHECKISRECEIVEELEMENTVALID_001 */
            {
...
\ID SBSW_OS_XSIGRECVCHECKISRECEIVEELEMENTVALID_001
 \DESCRIPTION    Os_XSigRecvCheckIsReceiveElementValid is called with the return value of Os_XSigChannelGetReceiveElement.
