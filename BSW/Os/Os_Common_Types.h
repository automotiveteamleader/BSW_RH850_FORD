...
/* module specific MISRA deviations:
  ...
  MD_Os_0306_PeripheralConfigType:
  ...
  MD_Os_STCAL:
      ...
      Prevention: None.
  MD_Os_STPAR:
      Reason:     Function has more than five parameters.
      Risk:       Caller could mix parameters.
      Prevention: Each parameter has a different data type. Therefore correct usage of function is ensured by compiler.
