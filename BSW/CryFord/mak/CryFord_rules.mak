...
# ----------   -------  ------ -----------------------------------------------#
# 2015-04-10   1.00.00  vismss Creation                                       #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += CryFord
CryFord_FILES            = CryFord\CryFord_MacSecAccess.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += CryFord\CryFord_MacSecAccess.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\CryFord_Cfg.c
